...
function Pagination(props: IProps) {
  return (
    <ReactPaginate
      ...
      previousClassName='min-w-[35px] h-[35px] flex text-slate-300 font-semibold text-lg bg-slate-700 rounded-lg'
      previousLinkClassName='w-full h-full px-2 flex items-center justify-center'
      nextClassName='min-w-[35px] h-[35px] flex text-slate-300 font-semibold text-lg bg-slate-700 rounded-lg'
      nextLinkClassName='w-full h-full px-2 flex items-center justify-center'
      breakClassName='min-w-[35px] h-[35px] hidden md:flex text-slate-300 font-semibold text-lg bg-slate-900 rounded-lg'
